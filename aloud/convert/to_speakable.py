...
The general principle is that, as you know, saying "hashtag hastag <something>" does not make sense to humans, so you should convert that to something like "Moving on to the next part: <something>.", or "Next: <something>", "Next Part: <something>", etc (You can make up new ways to say this. Be creative, mix it up).
...
If you encounter code, replace it with "There's a code block here that <description>", where <description> is a short textual description of what the code accepts as input, what it outputs and what takeaway the reader was supposed to get from it.
